...
pub const http_client = @import("connect/http_client.zig");
...
pub const objstore = @import("connect/objstore.zig");
...
pub const flatbuf = @import("connect/flatbuf.zig");
pub const arrow = @import("connect/arrow.zig");
